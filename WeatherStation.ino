...
#define DHTPIN 2        //Pin 2 is Data input 
#define DHTTYPE DHT22   //Senortype, in my case "DH22" 
...
void setup() {
  ...
  Serial.print("Send "); 
  Serial.print("'A'"); 
  Serial.println(" for humidity and temperature"); 
  dht.begin();
...
void loop() {  
 ...
 if (incomingChar == 'A') {   
    ...
    //show humidity, use serial communication 
    Serial.print("humidity "); 
    Serial.print(h);
    Serial.print("%\t");  
  
    //show temperature, use serial communication 
